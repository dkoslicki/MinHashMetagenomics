...
plt.savefig('../Paper/Figs/SimulatedBiologicalData_small.png')

# Save parameters for input to LaTeX paper
fid = open(os.path.abspath('../Paper/Data/SimulatedBiologicalData_small_NumGenomes.txt'), 'w')
fid.write('%d' % num_genomes)
fid.close()
fid = open(os.path.abspath('../Paper/Data/SimulatedBiologicalData_small_NumReads.txt'), 'w')
fid.write('%d' % num_reads)
fid.close()
fid = open(os.path.abspath('../Paper/Data/SimulatedBiologicalData_small_NumReplicates.txt'), 'w')
fid.write('%d' % num_replicates)
fid.close()
fid = open(os.path.abspath('../Paper/Data/SimulatedBiologicalData_small_p.txt'), 'w')
fid.write('%f' % p)
fid.close()
fid = open(os.path.abspath('../Paper/Data/SimulatedBiologicalData_small_ksize.txt'), 'w')
fid.write('%d' % ksize)
fid.close()
fid = open(os.path.abspath('../Paper/Data/SimulatedBiologicalData_small_rel_size.txt'), 'w')
