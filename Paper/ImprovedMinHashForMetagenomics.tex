...
\begin{figure}[!h]%
\begin{center}
\includegraphics[width=3.25in,trim={0 0 0 0in},clip]{Figs/ClassicalConceptual.png}%
\includegraphics[width=3.25in,trim={0 0 0 0in},clip]{Figs/ContainmentConceptual.png}
\end{center}
